...
//------------------------------setupConfigPanel --------------------------------//
    ...
    function draw(duration) {
        ...
        _this.sampleLegend.selectAll('.sample')
            ...
            .attr('transform', function (d) {
                var e = d3.select(this);
                return e.classed('dragging-x') ? e.attr('transform') : 'translate(' + (_this.scales.gridX(d) + _this.scales.gridX.bandwidth() / 2) + ',0)';
            });
        _this.demoTitles.selectAll('text')
            ...
            .attr('y', function (d) {
                var e = d3.select(this);
                return e.classed('dragging-y') ? e.attr('y') : _this.scales.demographicsY(d.field) + _this.scales.demographicsY.bandwidth() / 2;
            })
        _this.demoLegend.selectAll('.demolegend')
            .transition()
            .duration(duration)
